...
const Startscrn3 = ({navigation}) => {
  return (
    ...
    >
        ...
        Feel safe under carefull moderation
        </Text>
        <View>
    <Image style={{width:width*.5, height:height*.23, marginLeft:85, marginTop:50,marginBottom:5 }} source={require('../images/secure.png')}  />
       </View>
       <Text style={{textAlign:'center', color:'#444444', fontSize:18, padding :20, marginLeft:10, marginRight:10, marginBottom:10 }}>
        Our community is moderated by trained
        experts to ensure that you can communicate 
        openly.
       </Text>
